...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn("inline-flex h-9 items-center justify-center rounded-lg bg-[#161b26] p-1 text-slate-400", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-[#1c2232] data-[state=active]:text-white data-[state=active]:shadow",
      className
    )}
    {...props}
  />
